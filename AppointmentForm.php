	...
	<!-- Services -->
            ...
            <section class="row justify-content-center" >
                <section class="col-12 col-sm-6 col-md-3">
                    ...
                    <form class="form-container" action="appointmentFormInsert.php" method="post">
               ...
               <a href ="PatientPage.php"><button type="button" class="btn btn-primary "  style="background:#57ccc3" >Cancel</button></a> 
                </P>
