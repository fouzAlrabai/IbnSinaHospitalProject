...
<center><h4> Medical File <img src="file (1).svg" width="40" height="55"alt=""> </h4></center>
...
<center><h4>____________________________________________________________________________</h4><center>
		...
		if(isset($_POST['submit'])){
			...
			$query = "SELECT DISTINCT p.PName,p.File_Num,p.Age,p.Sex,ph.Med_Name,L.Test_Type,L.Result,L.LDate FROM pharmecy AS ph,
 laptest AS L,patient AS p WHERE p.File_Num= '$File_Num' AND ph.File_Num= '$File_Num'";
			$res=mysqli_query($link,$query); 
			 ...
			 echo"<th>"; echo "Age"; "</th>";
			 echo"<th>"; echo "Sex"; "</th>";
			 echo"<th>"; echo "Medications taken by the patient:"; "</th>";
			 echo"<th>"; echo "tests were conducted"; "</th>";
			 echo"<th>"; echo "The Test Result"; "</th>";
			 	 echo"<th>"; echo "Date of test"; "</th>";
			 echo"<th>"; echo ""; "</th>";
