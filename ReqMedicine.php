...
<h4 style="text-align:center;"> Fill the Form to Request a Medicine from the Pharmacy:</h4>
<form class="myForm" method="post"  action="MedicineFormInsert.php"> 
...
<p>
<label> Medicine Name  
<input type="text" id="medName" placeholder="Enter Medicine's Name" name="Medicine_name" required>
</label>
</p>

<p>
<label> Quantity
<input type="number" id="quantity" placeholder="Enter Medicine's quantity" name="Medicine_quan" required>
</label> 
</p>

<p>
<label>Prescription Details
<textarea name="details" id="details" rows = "5" cols = "90" ></textarea> 
</label> 
</p>
...
<button type= "reset" class= "btn-primary" value = "Clear" >Clear</button>
