...
$mysqli = new mysqli("localhost","root","","hospital");
  ...
  while ($row  )
  {
  echo '<tr ><td scope="col"><img src="images/user-account.png">'."   ".$row["PName"].'</td></tr>';
  echo '<td scope="col"><img img src="images/skyline.png">'."   ".$row["City"].'</td></tr>';
  echo '<td scope="col"><img img src="images/smartphone-call.png">'."   ".$row["Phone"].'</td></tr>';
  echo '<td scope="col"><img img src="images/age.png">'."   ".$row["Age"].'</td></tr>';
  echo '<td scope="col"><img img src="images/love.png">'."   ".$row["Sex"].'</td></tr>';
  echo '<td scope="col"><img img src="images/filenum.png">'."   ".$row["File_Num"].'</td></tr>';
  echo '<td scope="col"><img img src="images/username.png">'."   ".$row["UserName"].'</td></tr>';
  $row  = mysqli_fetch_array($result,MYSQLI_ASSOC);}
   ?>
               ...
               <a href="updatePatientAccountForm.php"><button type="submit" class="btn btn-primary btn-block" style="background:#57ccc3" >Modify Your Information</button> </a>  
